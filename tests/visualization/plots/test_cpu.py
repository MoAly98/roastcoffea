...
class TestPlotCPUUtilizationTimeline:
    """Test CPU utilization timeline plotting."""
    ...
    def test_returns_figure_and_axes(self, sample_tracking_data):
        """plot_cpu_utilization_timeline returns matplotlib Figure and Axes."""
        fig, ax = plot_cpu_utilization_timeline(sample_tracking_data)
    ...
    def test_saves_to_file(self, sample_tracking_data, tmp_path):
        ...
        fig, _ax = plot_cpu_utilization_timeline(
            sample_tracking_data, output_path=output_file
        )
    ...
    def test_handles_edge_case_zero_cpu(self):
        ...
        fig, ax = plot_cpu_utilization_timeline(tracking_data)
